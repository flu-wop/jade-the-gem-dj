...
export default function MerchBuildSuccess() {
  return (
    <div className="min-h-screen bg-background flex items-center justify-center px-4">
      <div className="text-center max-w-md">
        ...
        <p className="text-mist/50 font-body text-sm leading-relaxed mb-10">
          Your merch store build is confirmed. Check your email — just reply with
          your brand assets and product picks, and Jade will get started on concepts.
        </p>
        <div className="flex gap-4 justify-center">
          <Link href="/" className="btn-secondary">Back Home</Link>
          <Link href="/merch-build" className="btn-ghost">Back to Merch Build</Link>
        </div>
      </div>
    </div>
  );
